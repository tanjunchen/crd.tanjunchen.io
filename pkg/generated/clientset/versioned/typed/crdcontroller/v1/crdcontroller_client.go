...
import (
	...
	"crd.tanjunchen.io/pkg/generated/clientset/versioned/scheme"
...
// CrdV1Client is used to interact with features provided by the crd.tanjunchen.io group.
type CrdV1Client struct {
	restClient rest.Interface
}

func (c *CrdV1Client) Tanjunchens(namespace string) TanjunchenInterface {
	return newTanjunchens(c, namespace)
}
